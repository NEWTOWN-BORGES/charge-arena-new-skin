...
const CATALOG = [
	{"name": "BIT", "ultimate": "", "weapon": "Canhão de Braço", "bricks": "Baterias Aurora", "about": "O robô de série do circuito: cabeça-ecrã com sorriso, antena de sinal e um canhão de braço fiável.", "level": 0,
		"body": "", "light": "", "shot": ""},
	{"name": "SALVO", "ultimate": "volley", "weapon": "Lança-Mísseis Duplo", "bricks": "Caixas de munição", "about": "Artilheiro de oficina: cabeça larga com pega, lança-mísseis no ombro, braço pesado e cano duplo.", "level": 2,
	...
	{"name": "BROTO", "ultimate": "bloom", "weapon": "Semeador", "bricks": "Canteiros", "about": "Jardineiro de estufa: folhas como orelhas, vaso às costas, rodas nos pés e semeador de sementes de luz.", "level": 6,
		"body": "78bd57", "light": "d8ff8a", "shot": "b8f070"},
	{"name": "BIGORNA", "ultimate": "plating", "weapon": "Perfuradora", "bricks": "Bigornas", "about": "Pesado de estaleiro: cabeça-visor com pirilampo, faixas de perigo, lagartas de tanque e broca.", "level": 3,
	...
	{"name": "ROSCA", "ultimate": "sentries", "weapon": "Rebitadora", "bricks": "Engrenagens", "about": "Mecânica de bancada: óculos de soldador, olho de lupa, garra, rodas e caixa de ferramentas.", "level": 5,
		"body": "c9652e", "light": "ffc15a", "shot": "ffc15a"},
	{"name": "FAÍSCA", "ultimate": "thunder", "weapon": "Bobina de Tesla", "bricks": "Bobinas de Tesla", "about": "Caçador de tempestades: espigões de raio na cabeça, pernas de pássaro, bobina às costas e visor que varre.", "level": 8,
		"body": "2f7de0", "light": "7ff4ff", "shot": "8aeeff"},
	{"name": "BATIDA", "ultimate": "surge", "weapon": "Megafone de Choque", "bricks": "Colunas de som", "about": "DJ do circuito: orelhas de gato, auscultadores gigantes, colunas nos ombros e um megafone.", "level": 4,
